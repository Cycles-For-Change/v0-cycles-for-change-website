  ...
  const socialPlatforms = [
    {
      ...
      followers: "2.5K",
      posts: "150+",
      url: "https://www.instagram.com/cyclesforchange/",
      icon: Instagram,
    ...
    },
    {
      ...
      followers: "1.8K",
      posts: "75+",
      url: "https://www.tiktok.com/@cyclesforchange",
      icon: Music,
    ...
    {
      name: "YouTube",
      handle: "Cycles for Change",
      description: "In-depth videos about our mission, educational content, and documentary-style updates.",
      followers: "850",
      posts: "25+",
      url: "https://www.youtube.com/@cyclesforchange",
      icon: Youtube,
      color: "bg-gradient-to-r from-red-500 to-red-600",
      stats: [
        { label: "Videos", value: "25+" },
        { label: "Subscribers", value: "850" },
    ...
    },
    {
      ...
      followers: "320",
      posts: "12 Episodes",
      url: "https://open.spotify.com/show/cyclesforchange",
      icon: Music,
